                    ...
                    <div class="span8 offset2" id="articles">
                        ...
                        <?php echo form_open('s2e/contactValidation'); ?>
                            <ul>
                                ...
                                <li><label>Page<select><option>HOME</option>
                                                          <option>TIP</option>
                                                          <option>MIDS</option>
                                                          <option>HS</option>
                                                          <option>COL</option>
                                ...
                                </li><li><label>Section<select><option>Featured</option>
                                ...
                                <li><label>Title<input type="text" id="updatearticles" name="subject" placeholder="More Tips" width="200"></label></li>
